/**
 * 本地菜谱库（80 道）
 * 覆盖：红烧/炖煮、清蒸、炒菜、凉菜、汤羹、面食、主食、早餐、素食、海鲜
 * 配图通过 enrichRecipeMedia 由 dishImages.ts 智能匹配，不在此硬编码
 */
...
export const DEFAULT_RECIPES: Recipe[] = [...RAW, ...ADDITIONAL_RECIPES].map(enrichRecipeMedia)
